...
<div id="ILBoks">
    ...
    <form:form action="logInSjekk" modelAttribute="bruker">
        <div id="section">
            <div id="inputwrap">
              <form:input type="text" id="epostInnlogging" placeholder="E-post" path="epost"/><hr>
              <form:input type="password" id="passordInnlogging" placeholder="Passord" path="passord"/>
            </div>
        </div>
    <div id="feilmelding">
